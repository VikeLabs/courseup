...
export const useCreateTimetable = (props: UseCreateTimetableProps) => useMutate<CreateTimetableResponse, ValidateErrorJSON, void, TimetableParams, void>("PUT", `/timetables`, props);
