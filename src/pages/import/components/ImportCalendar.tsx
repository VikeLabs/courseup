...
import { SchedulerCalendarProps } from 'pages/scheduler/components/SchedulerCalendar';
...
export default function ImportCalendar({ calendarEvents }: SchedulerCalendarProps): JSX.Element {
