...
We use the [code generation](https://github.com/contiamo/restful-react/#code-generation-from-openapi--swagger-specs) capabilties to generate React hooks for all the resource routes to our backend. The generated code is located in [here.](./src/shared/fetchers.tsx). **DO NOT EDIT THIS FILE** as it is supposed to be generated from the OpenAPI spec.
